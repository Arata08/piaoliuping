...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__E79A481",
    appName: "星球社交-漂流瓶微信小程序版",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const tabbarEmits = {
  tabSwitch: (val, index2) => val instanceof Object && (isNumber(index2) || isString(index2)),
...
const switchEmits = {
  [UPDATE_MODEL_EVENT]: (val) => isBoolean(val) || isNumber(val) || isString(val),
  [CHANGE_EVENT]: (val, evt) => (isBoolean(val) || isNumber(val) || isString(val)) && evt instanceof Object
};
const radioProps = {
  ...commonProps,
  /**
...
exports.TABBAR_CONTEXT_KEY = TABBAR_CONTEXT_KEY;
exports.UPDATE_MODEL_EVENT = UPDATE_MODEL_EVENT;
exports._export_sfc = _export_sfc;
exports.animateEmits = animateEmits;
exports.animateProps = animateProps;
